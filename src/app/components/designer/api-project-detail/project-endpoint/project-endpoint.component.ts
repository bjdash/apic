...
export class ProjectEndpointComponent implements OnInit, OnDestroy {
  ...
  private handleEndpSelect(endpId: string) {
    ...
    let { summary, path, method, folder, traits, tags, security, operationId, schemes, description, deprecated, pathParams, queryParams, headers, body, responses, postrun, prerun, xProperties } = processedEndp;
    if (!folder) folder = '';
    this.endpForm.patchValue({ summary, path, method, folder, traits: [...traits], tags: [...(tags || [])], security: [...(security || [])], operationId, schemes: [...(schemes || [])], description, deprecated, pathParams, queryParams, headers, body: { ...body }, responses: [...(responses || [])], postrun, prerun, xProperties: [...(xProperties || [])] });
